...
Route::group(['middleware' => ['web', 'auth', 'roles', 'maintenis', 'profil', 'nilai']], function () {
    ...
    //HASIL KEGIATAN
    Route::post('kegiatan/{kegiatan}/kirim', [
        'as' => 'kegiatan.hasil.store',
        'roles' => ['mahasiswa'],
        'uses' => 'HasilKegiatanController@store'
    ]);
    Route::get('kegiatan/{kegiatan}/nilai/{mahasiswa}', [
        'as' => 'kegiatan.hasil.nilai.form',
        'roles' => ['administrator', 'akademik', 'dosen'],
        'uses' => 'HasilKegiatanController@nilai'
    ]);

    Route::post('kegiatan/{kegiatan}/nilai/{mahasiswa}', [
        'as' => 'kegiatan.hasil.nilai.store',
        'roles' => ['administrator', 'akademik', 'dosen'],
        'uses' => 'HasilKegiatanController@nilaiPost'
    ]);
