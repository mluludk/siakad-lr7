...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Penelitian Mahasiswa</li>
	</ol>
</section>
@endsection
...
<div class="row">
	...
	<div class="col-sm-9">	
		...
		<div class="box box-danger">
			<div class="box-header with-border">
				<h3 class="box-title">Riwayat Penelitian Mahasiswa</h3>
				<div class="box-tools">
					<a href="{{ route('mahasiswa.penelitian.create', $mahasiswa -> id) }}" class="btn btn-primary btn-xs btn-flat" title="Input Data Penelitian Mahasiswa"><i class="fa fa-plus"></i> Tambah Penelitian</a>
				</div>
			</div>
			<div class="box-body">
