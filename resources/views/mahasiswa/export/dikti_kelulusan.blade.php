...
<section class="content-header">
	<h1>
		Mahasiswa
		<small>Ekspor Data Kelulusan PDDIKTI</small>
	</h1>		
	<ol class="breadcrumb">
		<li><a href="/"><i class="fa fa-dashboard"></i> Home</a></li>
		<li><a href="{{url('/mahasiswa/') }}"><i class="fa fa-dashboard"></i> Mahasiswa</a></li>
		<li class="active">Ekspor Data Kelulusan PDDIKTI</li>
	</ol>
</section>
@endsection
...
<div class="box">
	...
	<div class="box-body">
		{!! Form::open(['url' => url('/export/dikti/kelulusan'), 'class' => 'form-horizontal', 'autocomplete' => 'off']) !!}
