...
<div class="form-group">
	{!! Form::label('tanggal_mulai', 'Tanggal PKM', array('class' => 'col-sm-3 control-label')) !!}
	<div class="col-sm-9">
		<div class="inline">
			{!! Form::text('tanggal_mulai', null, array('class' => 'form-control date', 'autocomplete' => 'off', 'placeholder' => 'Tanggal Mulai PKM', 'required' => 'required')) !!}
		</div>
		<div class="inline">
			{!! Form::text('tanggal_selesai', null, array('class' => 'form-control date', 'autocomplete' => 'off', 'placeholder' => 'Tanggal Selesai PKM', 'required' => 'required')) !!}
		</div>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<div class="inline">
			{!! Form::text('tgl_mulai_daftar', null, array('class' => 'form-control date', 'autocomplete' => 'off', 'placeholder' => 'Tanggal Mulai Pendaftaran PKM', 'required' => 'required')) !!}
		</div>
		<div class="inline">
			{!! Form::text('tgl_selesai_daftar', null, array('class' => 'form-control date', 'autocomplete' => 'off', 'placeholder' => 'Tanggal Selesai Pendaftaran PKM', 'required' => 'required')) !!}
		</div>
	</div>
</div>
<div class="form-group">
