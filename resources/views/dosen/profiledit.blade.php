				...
				<div class="col-sm-9">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							<div style="display:block; float: left; margin-right: 2px; width: 200px;">
								{!! Form::text('tmt_sk_awal', null, array('class' => 'form-control date', 'placeholder' => 'TMT SK Awal Dosen', 'autocomplete' => 'off')) !!}
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<div style="display:block; float: left; margin-right: 2px; width: 200px;">
								{!! Form::text('tmt_sk_terbaru', null, array('class' => 'form-control date', 'placeholder' => 'TMT SK Terbaru Dosen', 'autocomplete' => 'off')) !!}
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							{!! Form::text('tmt_pns_p', null, array('class' => 'form-control', 'placeholder' => 'TMT PNS Suami / Istri', 'autocomplete' => 'off')) !!}
						</div>
					</div>
					<div class="form-group">
