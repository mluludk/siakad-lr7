		...
		<div class="box box-primary">
			<div class="box-header with-border">	
				<div class="box-tool pull-right">
					<a href="{{ route('user.profile.edit') }}" class="btn btn-warning btn-xs btn-flat" title="Edit data dosen"><i class="fa fa-pencil-square-o"></i> Edit Data</a>
				</div>
			</div>
			<div class="box-body">
				<div class="row">
			...
			<div class="tab-content">
				<div class="tab-pane" id="homebase">
					<table class="table table-bordered table-striped">
						<tbody>
							<tr><th width="18%">BIDANG KEAHLIAN</th><td>@if(isset($prodi[$dosen -> bid_keahlian])) {{ $prodi[$dosen -> bid_keahlian] }} @else - @endif</td></tr>
							<tr>
								<th>BIDANG MATKUL</th>
								<td>
				...
				<div class="tab-pane active" id="biodata">
					<table class="table table-bordered table-striped">
						<tbody>
							...
							<tr><th>KABUPATEN</th><td> {{ $dosen -> kab }}</td><th>PROVINSI:</th><td colspan="3">{{ config('custom.pilihan.emis.provinsi')[$dosen -> provinsi] }}</td></tr>
				...
				<div class="tab-pane" id="keluarga">
					<table class="table table-bordered table-striped">
						<tbody>
							...
							<tr><th>NAMA SUAMI / ISTRI </th><td>{{ $dosen->nama_p }}</td></tr>
							<tr><th>NIP SUAMI / ISTRI </th><td>{{ $dosen->nip_p }}</td></tr>
							<tr><th>TMT PNS </th><td>{{ $dosen->tmt_pns_p }}</td></tr>
						<tr><th>PEKERJAAN</th><td>{{ config('custom.pilihan.pekerjaanOrtu')[$dosen->pekerjaan_p] }}</td></tr>
						</tbody>
						</table>
						</div>
