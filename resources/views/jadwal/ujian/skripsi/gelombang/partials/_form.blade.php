...
<div class="form-group">
	...
	<div class="col-sm-5">
		<p class="form-control-static">{{ $ujian -> no_surat }}</p>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-5">
		<p class="form-control-static">{{ $ujian -> nama }}</p>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-3">
		{!! Form::text('tgl_mulai', null, array('class' => 'form-control date', 'placeholder' => 'Tanggal Mulai', 'required' => 'required', 'autocomplete' => 'off')) !!}
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-3">
		{!! Form::text('tgl_selesai', null, array('class' => 'form-control date', 'placeholder' => 'Tanggal Selesai', 'required' => 'required', 'autocomplete' => 'off')) !!}
	</div>
</div>
