...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/float-label.css') }}">
    <style>
        html {
            height: 100%;
...
<body>
                                            ...
                                            <form role="form" method="POST"
                                                ...
                                                <div class="form-group has-float-label">
                                                    <input type="text" class="form-control" name="username"
                                                        value="{{ old('username') }}" autofocus="autofocus"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <a class="btn btn-info btn-block" disabled="disabled"><i
                                                            class="fa fa-srefresh"></i> Lupa Password?</a>
                                                    @else
                                                    <a class="btn btn-info btn-block"
                                                        href="{{ url('/password/username') }}"><i class="fa fa-key"></i>
                                                        Lupa Password?</a>
                                                    @endif
                                                </div>
                                            </form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        Jika anda menemukan kesalahan (Error) pada SIAKAD harap segera melapor kepada Admin SIAKAD,
                        disertai dengan deskripsi kesalahan
    ...
    <div class="modal fade modal-info" id="about" tabindex="-1" role="dialog" aria-labelledby="about-title"
        aria-hidden="true">
        <div class="modal-dialog">
