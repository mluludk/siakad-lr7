<div id="myModal" class="modal fade">
	...
	<script>
		...
		$(document).on('click', '#btn-upload-{{ $rand }}', function(){		
			...
			{
				alert('Pilih File terlebih dahulu'); return false;
			}
			else{
		...
		$(document).on('click', '#btn-pilih-{{ $type }}-{{ $rand }}', function(){
			...
			if(cb.length < 1) { alert('Pilih data terlebih dahulu'); return false;}
		...
		function addVideo(id, url, mime)
		{
			...
			var vid_block = '<div class="col-sm-4"><div class="thumbnail"><video width="320" height="240" controls>' +  
