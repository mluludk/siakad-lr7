...
<div class="form-group">
	...
	<div class="col-md-9">
		<div class="gambar-preview col-md-12" style="margin: 0 -20px"></div>
...
<div class="form-group">
	...
	<div class="col-md-9">
		...
		<button class="btn btn-success btn-flat modal-link btn-xs btn-video" type="button" data-toggle="modal" href="#myModal" data-href="{{ route('file.manager', 'video') }}">
...
<div class="form-group">
	...
	<div class="col-md-5">
		<div id="summernote">{!! $sesi -> catatan ?? '' !!}</div>
		</div>
	</div>
