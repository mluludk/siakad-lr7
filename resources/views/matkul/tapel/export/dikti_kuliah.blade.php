...
@section('title')
Ekspor Data Kelas Perkuliahan PDDIKTI
@endsection
...
<section class="content-header">
	<h1>
		Kelas Perkuliahan
		<small>Ekspor Data PDDIKTI</small>
	</h1>		
	<ol class="breadcrumb">
		<li><a href="/"><i class="fa fa-dashboard"></i> Home</a></li>
		<li><a href="{{url('/matkul/tapel/') }}"><i class="fa fa-dashboard"></i> Kelas Perkuliahan</a></li>
		<li class="active">Ekspor Data PDDIKTI</li>
	</ol>
</section>
@endsection
...
<div class="box">
	...
	<div class="box-body">
		{!! Form::open(['url' => url('/export/dikti/kelaskuliah'), 'class' => 'form-horizontal', 'autocomplete' => 'off']) !!}
