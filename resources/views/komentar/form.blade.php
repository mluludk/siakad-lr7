...
<div class="f-box">
    <div class="f-box-body">
        ...
        <form action="{{ route('komentar.post', ['Kegiatan', $kegiatan -> id]) }}" method="post"
            id="frm-komentar" data-time="0">
            {!! csrf_field() !!}
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <button class="btn btn-default modal-link" type="button" data-toggle="modal"
                        href="#myModal" data-href="{{ route('file.manager', 'gambar') }}"><i
                            class="fa fa-image"></i>&nbsp;</button>
                    <button class="btn btn-default modal-link" type="button" data-toggle="modal"
                        href="#myModal" data-href="{{ route('file.manager', 'video') }}"><i
                            class="fa fa-video-camera"></i>&nbsp;</button>
                    <button class="btn btn-default modal-link" type="button" data-toggle="modal"
                        href="#myModal" data-href="{{ route('file.manager', 'dokumen') }}"><i
