...
class FileEntryController extends Controller
{
    ...
    public function manager(Request $request, $type = 'dokumen', $rnd = 'fm')
    {
        $auth = \Auth::user();
        ...
        return view('file.manager', compact('type', 'file', 'rand', 'icons', 'rnd'));
    }
    ...
    public function getFile($y, $m, $d, $f)
    {
        ...
        $mime = $mime == null ? class_exists('finfo') ? $storage->mimeType($filename) : 'Image/PNG' : $mime;
